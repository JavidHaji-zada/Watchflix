                            ...
                            userType == 'individual' ? (
                                <div style={{ display: 'flex', flexDirection: 'row' }}>
                                    <div style={{ marginRight: 20 }}>
                                        ...
                                        <Form.Group controlId="formBasicCheckbox" style={{ display: 'flex', flexDirection: 'column' }}>
                                            <Form.Label>Birthday</Form.Label>
                                            <input
                                                style={{ borderColor: APP_COLORS.inputBorderGray, borderStyle: 'solid', borderWidth: 1, borderRadius: 6, padding: 6, color: APP_COLORS.inputPlaceholder }}
                                                type="date" id="birthday" name="birthday" min="1900-01-01" max="2007-01-01"
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '10%', width: '100%' }}>
                {
                    userType == 'individual' ? (
                        currentStage == 3 ? (
                            <Button style={styles.nextButton} onClick={finalizeRegistration} variant="danger">Register Me!</Button>
                        ) : (
                                <Button style={styles.nextButton} onClick={() => setCurrentStage(currentStage + 1)} variant="danger">Next</Button>
                            )
                    ) :
                        (
                            currentStage == 2 ? (

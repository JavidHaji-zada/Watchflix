...
function Movie(): JSX.Element {
    ...
    const [selfMovie, setMovies] = useState<MediaProduct[]>([]);
    ...
    useEffect(() => {
        ...
        let movies = []
        movies.push(mediaProduct1,mediaProduct11, mediaProduct13, mediaProduct14, mediaProduct12, mediaProduct23, mediaProduct21,mediaProduct2, mediaProduct3, mediaProduct3)
        setMovies(movies);
    ...
    return(
        ...
        >
          {selfMovie?.map((media: MediaProduct) => (
